"use strict";(self.webpackChunk=self.webpackChunk||[]).push([[474],{3474:(t,e,n)=>{n.d(e,{SIWEController:()=>o,getDidAddress:()=>s.q_h,getDidChainId:()=>s.aG$});var i=n(666);n(2538);var s=n(1650),a=n(5476),r=n(8520);const c=(0,r.BX)({status:"uninitialized"}),o={state:c,subscribeKey:(t,e)=>(0,a.u$)(c,t,e),subscribe:t=>(0,r.B1)(c,(()=>t(c))),_getClient(){if(!c._client)throw new Error("SIWEController client not set");return c._client},async getNonce(t){const e=this._getClient(),n=await e.getNonce(t);return this.setNonce(n),n},async getSession(){try{const t=this._getClient(),e=await t.getSession();return e&&(this.setSession(e),this.setStatus("success")),e}catch{return}},createMessage(t){const e=this._getClient().createMessage(t);return this.setMessage(e),e},async verifyMessage(t){const e=this._getClient();return await e.verifyMessage(t)},async signIn(){const t=this._getClient();return await t.signIn()},async signOut(){const t=this._getClient();await t.signOut(),this.setStatus("ready"),this.setSession(void 0),t.onSignOut?.()},onSignIn(t){const e=this._getClient();e.onSignIn?.(t)},onSignOut(){const t=this._getClient();t.onSignOut?.()},setSIWEClient(t){c._client=(0,r.KR)(t),c.status="ready",i.Hd.setIsSiweEnabled(t.options.enabled)},setNonce(t){c.nonce=t},setStatus(t){c.status=t},setMessage(t){c.message=t},setSession(t){c.session=t,c.status=t?"success":"ready"}};var l=n(8377),u=n(178);const g=u.AH`
  :host {
    display: flex;
